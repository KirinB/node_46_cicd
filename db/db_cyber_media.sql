...
(1, 'okay ?', 12, 13, '2025-02-26 08:57:17', '2025-02-26 08:57:17');
INSERT INTO `chats` (`chat_id`, `message`, `user_id_sender`, `user_id_recipient`, `created_at`, `updated_at`) VALUES
(2, 'okay rồi', 13, 12, '2025-02-26 09:03:07', '2025-02-26 09:03:07');
INSERT INTO `chats` (`chat_id`, `message`, `user_id_sender`, `user_id_recipient`, `created_at`, `updated_at`) VALUES
(3, 'được không?', 12, 13, '2025-02-26 09:04:28', '2025-02-26 09:04:28');
INSERT INTO `chats` (`chat_id`, `message`, `user_id_sender`, `user_id_recipient`, `created_at`, `updated_at`) VALUES
(4, 'plau', 13, 12, '2025-02-26 09:04:33', '2025-02-26 09:04:33'),
(5, 'dkqmwdqw', 13, 12, '2025-02-26 09:04:34', '2025-02-26 09:04:34'),
(6, '123', 12, 8, '2025-02-26 09:13:37', '2025-02-26 09:13:37');

INSERT INTO `permissions` (`permission_id`, `name`, `endpoint`, `method`, `module`, `created_at`, `updated_at`) VALUES
(1, 'READ VIDEO', '/video/video-list', 'GET', 'videos', '2025-01-17 09:59:31', '2025-01-17 09:59:31');
INSERT INTO `permissions` (`permission_id`, `name`, `endpoint`, `method`, `module`, `created_at`, `updated_at`) VALUES
(2, 'CREATE_VIDEO', '/video/video-create', 'GET', 'videos', '2025-01-17 09:59:31', '2025-01-17 09:59:31');


INSERT INTO `role_permissions` (`role_permissions_id`, `role_id`, `permission_id`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 2, 1, 1, '2025-01-17 10:02:55', '2025-01-26 02:47:24');
INSERT INTO `role_permissions` (`role_permissions_id`, `role_id`, `permission_id`, `is_active`, `created_at`, `updated_at`) VALUES
(2, 2, 2, 1, '2025-01-17 10:06:55', '2025-01-17 10:06:55');


INSERT INTO `roles` (`role_id`, `name`, `description`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'ROLE_ADMIN', 'Quản trị viên', 1, '2025-01-17 09:55:12', '2025-01-17 09:55:12');
INSERT INTO `roles` (`role_id`, `name`, `description`, `is_active`, `created_at`, `updated_at`) VALUES
(2, 'ROLE_USER', 'Người dùng hệ thống', 1, '2025-01-17 09:55:59', '2025-01-17 09:55:59');
...
INSERT INTO `users` (`user_id`, `email`, `pass_word`, `full_name`, `avatar`, `goole_id`, `face_app_id`, `created_at`, `updated_at`, `role_id`) VALUES
(2, 'kirin@gmail.com', '1234', 'Minh Nhan', NULL, NULL, NULL, '2024-12-29 02:52:04', '2024-12-29 02:52:04', 2);
INSERT INTO `users` (`user_id`, `email`, `pass_word`, `full_name`, `avatar`, `goole_id`, `face_app_id`, `created_at`, `updated_at`, `role_id`) VALUES
(3, 'kirin1@gmail.com', '1234', 'Minh Nhan', NULL, NULL, NULL, '2024-12-29 03:05:05', '2024-12-29 03:05:05', 2);
INSERT INTO `users` (`user_id`, `email`, `pass_word`, `full_name`, `avatar`, `goole_id`, `face_app_id`, `created_at`, `updated_at`, `role_id`) VALUES
(4, 'kirin2@gmail.com', '$2b$10$Yw7PYl0gn2ejkYVKhriJG.XafR.axA96yn52Svz6hOcG0Sh2O8r0i', 'Minh Nhan', NULL, NULL, NULL, '2024-12-29 03:13:25', '2024-12-29 03:13:25', 2),
(5, 'kirin3@gmail.com', '$2b$10$jPq3QhU2aFu2VMP1FF6ThOXKfwy9qfy43wAYXWeX0a1MPk38zheL6', 'Minh Nhan', NULL, NULL, NULL, '2024-12-29 03:18:24', '2024-12-29 03:18:24', 2),
(6, 'nhan@gmail.com', '$2b$10$IYJl4aQLnCq9mUx.FsMVz.AfZfI28Xe/HyGSyZiAxmAJCQwS6G02i', 'nhannhan', NULL, NULL, NULL, '2024-12-29 03:37:31', '2024-12-29 03:37:31', 2),
(7, 'lejape@mailinator.com', '$2b$10$7Ph4tbaL7QW4VmhRkYkkW.FaYubxZP.pp/TgV1kzlit5gZMGslfau', 'Honorato Bowen', NULL, NULL, NULL, '2024-12-29 03:37:46', '2024-12-29 03:37:46', 2),
(8, 'admin@gmail.com', '$2b$10$/nkNB0HWSpQjelFGsq/YSucyGpGQd.I.AbJTLygvLM0cAiU38WTb.', 'nhannhan', 'local-avatar-1741083528365-770115083.jpg', NULL, NULL, '2024-12-29 04:17:51', '2025-03-04 10:18:48', 2),
(9, 'kobkirin@gmail.com', NULL, 'Ju Nhậ', NULL, NULL, '1148763576840485', '2025-01-11 10:39:11', '2025-01-18 06:51:03', 2),
(10, 'nhan7@gmail.com', '$2b$10$u.7E7lk.hC1uQYctw67/mu1.PpNZK8LyokcZxjCcNxpkVbcN5cc5m', 'nhan7', NULL, NULL, NULL, '2025-02-10 10:04:08', '2025-02-10 10:04:08', 2),
(11, 'nhan9@gmail.com', '$2b$10$LiBDdVAQQNHzZA4Ow12KSu9M72vxCRd5yWEFS/EaDyusA92G2Jz7q', 'nhan9', NULL, NULL, NULL, '2025-02-10 10:07:36', '2025-02-10 10:07:36', 2),
(12, 'nhan11@gmail.com', '$2b$10$C40c9qTTSgIswuh3ZVH73uXg5EhHjt8HlteEBdMcsQN.pOGp40KEu', 'nhannhan', NULL, NULL, NULL, '2025-02-20 02:15:38', '2025-02-20 02:15:38', 2),
(13, 'nhan22@gmail.com', '$2b$10$jAY/O9rAcfzL6UV1yaSfyOZ1jhkotNULQPE0uTYOyqrEdy0Cv2s.S', 'nhannhan', NULL, NULL, NULL, '2025-02-20 02:15:51', '2025-02-20 02:15:51', 2);
...
(10, 'minh nhânnnn', NULL, '2025-03-06 08:44:46', '2025-03-06 08:44:46'),
(11, 'string hello', NULL, '2025-03-06 08:56:41', '2025-03-06 08:56:41');
